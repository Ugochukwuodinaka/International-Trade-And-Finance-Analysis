...
- Changed the data type of thise fields that are of the wrong data type to the right data type.
- Made sure that all the data types of the 5 tables in the dataset are of the right data type.
<br />
